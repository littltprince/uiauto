...
class Email:
    def __init__(self):
        ...
        host = "smtp.163.com"
        user = "13051935199@163.com"
        password = "abc123zx"
        port = "25"
        sender = "13051935199@163.com"
        title = "接口测试报告"
        # content = localReadConfig.get_email("content")

        # get receiver list
        self.value = "875431447@qq.com/1021030222@qq.com"
        self.receiver = []
    ...
    def config_header(self):
        """
        efined email headder include subject, sender and receiver
        定义电子邮件标题包括主题、发件人和收件人
        :return:
        """
    ...
    def config_content(self):
        ...
        :return:
        """
        f = open(os.path.join(proDir, 'testFile', 'emailStyle.txt'))
        content = f.read()
        f.close()
    ...
    def config_image(self):
        ...
        """
        # defined image path
        image1_path = os.path.join(proDir, 'testFile', 'img', '1.png')
        ...
        image2_path = os.path.join(proDir, 'testFile', 'img', 'logo.jpg')
    ...
    def config_file(self):
        ...
        if self.check_file():
            ...
            zippath = os.path.join(proDir, "result", "test.zip")
